...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest info_city.client -- --template=react  --no-rolldown --no-immediate`.
...
- Crear archivo de proyecto (`info_city.client.esproj`).
